...
export const controlCenterCards: ControlCenterCard[] = [
  ...
  },
  {
    ...
    description: 'Main hospital module on/off. Satellites are optional — not clinical departments.',
    category: 'Organization',
    icon: <Building2 className="h-6 w-6" />,
    keywords: ['clinic', 'satellite', 'modules', 'opd', 'ipd', 'multi-facility'],
    help: 'Enable extra physical sites only if you run satellites. Clinical departments are configured separately.',
  },
  {
    id: 'users',
  ...
  },
  {
    ...
    description: 'Set the KES amount for each clinic. OPD and cashier use these mapped fees.',
    category: 'Finance (directors)',
    icon: <Wallet className="h-6 w-6" />,
    keywords: ['pricing', 'billing', 'finance', 'director', 'money', 'clinic', 'fee'],
  ...
  },
  {
    ...
    category: 'Finance (directors)',
    icon: <Shield className="h-6 w-6" />,
    keywords: ['sha', 'nhif', 'insurance', 'eligibility', 'hie', 'shif', 'uhc'],
    help: 'Check SHA coverage with National ID or Client Registry ID. Do not treat a captured SHA number as verified cover.',
  },
  {
    id: 'notifications',
